...
//        //then
//        assertThat(repository.findAllByDrawDateAndMessage(LocalDateTime.of(2023, 2, 4, 20, 0)).size()).isEqualTo(8);
//        assertThat(repository.findAllByDrawDateAndMessage(LocalDateTime.of(2023, 2, 4, 20, 0)).get(0).message())
...
//        resultCheckerFacade.transformToResult();
//        //then
//        assertThat(repository.findAllByDrawDateAndMessage(LocalDateTime.of(2023, 2, 4, 20, 0))).hasSize(4);
//        assertThat(repository.findAllByDrawDateAndMessage(LocalDateTime.of(2023, 2, 4, 20, 0)).get(0).message())
//                .isEqualTo("The numbers have not been drawn yet");
//    }
//
...
//        //then
//        assertThat(repository.findAllByDrawDateAndMessage(LocalDateTime.of(2023, 1, 28, 20, 0)).size()).isEqualTo(3);
